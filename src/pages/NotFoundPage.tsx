...
const NotFoundPage = () => {
  return (
    <main className="flex justify-center items-center h-screen min-h-full place-items-center bg-gray-900 px-6 py-24 sm:py-32 lg:px-8">
      <div className="text-center">
        <p className="text-base font-semibold text-[#393]">404</p>
